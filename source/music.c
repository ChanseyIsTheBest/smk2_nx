...
/* Stop and release whatever is playing. Called from main()'s teardown, before
 * opensles_shutdown(), so the mixer is not still reading a track's PCM while
 * the audio device is being torn down underneath it. */
